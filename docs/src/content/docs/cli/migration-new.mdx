...
To use your own starting content instead of the default template, set [`template_up`](/reference/config/#template_up) in `spawn.toml` to a path (relative to `spawn_folder`) of a file to copy into `up.sql`.
