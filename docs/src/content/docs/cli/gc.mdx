...
The `gc` command identifies and removes these orphaned files to reclaim disk space and keep your repository clean.
...
- **Before committing**: Run `spawn gc --dry-run` to check if there are orphans worth cleaning up
