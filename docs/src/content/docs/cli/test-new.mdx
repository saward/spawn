...
To use your own starting content instead of the default template, set [`template_test`](/reference/config/#template_test) in `spawn.toml` to a path (relative to `spawn_folder`) of a file to copy into `test.sql`.
